...
\term{Zygmund Class}
A function belongs to a Zygmund class when its second difference satisfies a bound such as $|f(x+h)+f(x-h)-2f(x)|\le C|h|$ for all relevant $x$ and $h$. This describes a form of smoothness close to, but slightly weaker than, Lipschitz continuity. \par\noindent\textbf{Applications:} Zygmund classes help analyze Fourier series, approximation error, and the behavior of functions near singularities.
