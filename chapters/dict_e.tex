...
\term{Elliptic Curve}
A smooth curve of genus 1 with a chosen point at infinity. Over a field of characteristic different from $2$ and $3$, it can be written as $y^2=x^3+ax+b$ with $4a^3+27b^2\ne0$. Its points form an abelian group under a geometric addition rule. Applications: elliptic curves are used in public-key cryptography, integer factorization, and the study of rational solutions to equations.
