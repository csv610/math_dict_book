...
\term{Zygmund Class}
A class of functions $\Lambda_*$ that are "slightly more" than Lipschitz continuous, defined by the condition $|f(x+h) + f(x-h) - 2f(x)| \leq C|h|$. They appear in the study of harmonic analysis and approximation theory.
